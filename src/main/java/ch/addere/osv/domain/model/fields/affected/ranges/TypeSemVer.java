 ...
 */
public final class TypeSemVer implements Ranges {

  private final Type type;
  private final Repo repo;
  private final List<SemVerEvent> events;

  private TypeSemVer(Repo repo, SemVerEvent... event) {
    this.type = Type.SEMVER;
    this.repo = repo;
    this.events = List.of(event);
  }

  public static TypeSemVer of(SemVerEvent... events) {
    return new TypeSemVer(null, events);
  }

  public static TypeSemVer of(Repo repo, SemVerEvent... events) {
    return new TypeSemVer(repo, events);
  }
